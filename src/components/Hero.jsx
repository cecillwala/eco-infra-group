...
const backgroundImage = "https://res.cloudinary.com/duwyaucf1/image/upload/v1774817868/Screenshot_2026-03-29_235554_gkdzse.png";
      ...
      <div className="absolute inset-0 flex flex-col justify-center items-center text-center bg-black bg-opacity-30 px-4">
        <div className="max-w-4xl bg-black bg-opacity-70 p-8 rounded-lg">
          ...
          <p className="text-lg md:text-xl text-white leading-relaxed max-w-2xl mx-auto">
            Ecos Infra Group is an economic and social infrastructure investments and advisory company operating across Africa
          </p>
        </div>
      </div>
    </section>
